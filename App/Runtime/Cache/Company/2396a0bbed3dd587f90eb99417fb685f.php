              ...
              <div class="panel with-nav-tabs panel-info panel-square panel-no-border">
                ...
                <!-- 右侧小按钮 -->
                  ...
                  <ul class="nav nav-tabs">
                    <li class="active">
                      <a href="#example-search-supervisor" data-toggle="tab">
                        督导库
                      </a>
                    </li>
                  ...
                  <div class="panel-body">
                    <div class="container-fluid">
                      <div class="tab-content">
                        <!-- 第一栏 -->
                        <div class="tab-pane fade active in" id="example-search-supervisor">
                          <!-- 表格 -->
                      ...
                      <tbody role="alert" aria-live="polite" aria-relevant="all">
                        <!-- 新起一行 -->
                        <!--<?php if(is_array($$rel['data']['list'])): foreach($$rel['data']['list'] as $key=>$$v): ?>-->
                        <tr>
                          <td>
                            <!-- <input type="checkbox" name="" class="chk"> -->
                            <div class="checkbox checkbox-info checkbox-inline checkbox-single">
                              <input id="supervisorCheckbox1" type="checkbox">
                              <label for="supervisorCheckbox1"></label>
                            </div>
                          </td>
                        ...
                        <!-- 新起一行 -->
                        <?php if(is_array($rel['data']['list'])): foreach($rel['data']['list'] as $key=>$v): ?><tr>
                          <td>
                            <!-- <input type="checkbox" name="" class="chk"> -->
                            <div class="checkbox checkbox-info checkbox-inline checkbox-single">
                              <input id="supervisorCheckbox2" type="checkbox">
                              <label for="supervisorCheckbox2"></label>
                            </div>
                          </td>
                          <td class="text-blue">肖允瀚</td>
                        ...
                        <tr>
                          <td>
                            <!-- <input type="checkbox" name="" class="chk"> -->
                            <div class="checkbox checkbox-info checkbox-inline checkbox-single">
                              <input id="supervisorCheckbox3" type="checkbox">
                              <label for="supervisorCheckbox3"></label>
                            </div>
                          </td>
                          <td class="text-blue">肖允瀚</td>
                          <td>男</td>
                          ...
                          <div class="pull-left bottom-btn-group">
                            <div class="checkbox checkbox-info checkbox-inline">
                              <input id="supervisorCheckbox0" name="full-select" type="checkbox">
                              <label for="supervisorCheckbox0">全选</label>
                            </div>
