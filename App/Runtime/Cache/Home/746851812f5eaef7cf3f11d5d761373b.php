	...
	<body>
		<div class="layout">
			...
			<div class="mycenter yapiskan ">
				...
				<h2 class="grzc">企业注册</h2>
				<h2 class="qhsf"><a href="<?php echo U('grzc');?>">切换身份</a></h2>
			</div>
			...
			<div class="change_password">
				<form action="" method="post">
					<ul>
						<li>
							<input class="grzc-input mobel" type="text" name="qy_register_phone" id="qy_register_phone" value="" placeholder="请输入手机号" />
							<i class="qchm" id="qchm"></i>
						</li>

						<li>
							<input class="grzc-input" type="text" name="qy_register_code" id="qy_register_code" value="" placeholder="请输入验证码" />
							<div class="grzc-button" name="101" id="getcode">获取验证码</div>
						</li>
						<li>
							<input class="grzc-input mcmm" name="qy_register_pass" class="txt1" id="qy_register_pass" type="password" value="" placeholder="请输入密码" />
							<i class="user-eyek"></i>
						</li>
						<li><input class="grzc-input" type="text" name="qy_register_invite_code" id="qy_register_invite_code" value="" placeholder="邀请码(可不填)" /></li>
					</ul>
					<input type="button" class="btn" name="200" id="qy_register_btn" value="确认" />
				</form>
