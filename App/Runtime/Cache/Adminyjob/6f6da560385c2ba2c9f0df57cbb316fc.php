                ...
                <div class="">
                    <div class="panel with-nav-tabs panel-info panel-square panel-no-border">
                        <div class="panel-body body-waiwei">
                            ...
                            <table class="f-tab table-hover table-condensed table-striped table-bordered table" id="hidden-table-info">
                                <thead>
                                <tr role="row">
                                    <th>&nbsp;</th>
                                    <th>
                                        <select class="form-control f-input-sm">
                                            <option value="" selected="selected">全部BD</option>
                                            <option value="">管理权限</option>
                                            <option value="">查看权限</option>
                                ...
                                <tr>
                                    ...
                                    <td>15212234876</td>
                                    <td>
                                        最近登录：2016年11月12日 20：80
                                    </td>
                                    <td class="text-center"><i class="fa fa-plus-circle jiahao"></i></td>
                                </tr>
                                <tr class="newTr">
						            <td colspan="12">
						            	<ul class="unstyled inline">
								            ...
								            <li class="wx-new"><a href=""><span class="wx-span1" style="color: #999999;">好多字说没就没了</span><span class="wx-span2" style="color: #999999;">恩，是啊，说没就没了</span></a></li>
								            <li class="wx-new"><a href=""><span class="wx-span1" style="color: #999999;">好多字说没就没了</span><span class="wx-span2" style="color: #999999;">恩，是啊，说没就没了</span></a></li>
								            <li class=" wx-new tc"><a href="#"><span class="wx-span1">个人魅力卡</span></a></li>
						                </ul>
						                
						                <div class="wx-a">
											<div class="wx-top">
											    <div  class="wx-close">×</div>
											    <h4 class="wx-title">个人魅力卡</h4>
											</div>
											<div class="wx-center">
												<ul class="wx-ul">
													<li class="wx-li">
														<span class="wx-left">昵称：</span>
														<span class="wx-right">恩，就是这个昵称</span>
													</li>
													<li class="wx-li">
														<span class="wx-left">真实姓名：</span>
														<span class="wx-right">刘德华6</span>
													</li>
													<li class="wx-li">
														<span class="wx-left">性别：</span>
														<span class="wx-right">男</span>
													</li>
													<li class="wx-li">
														<span class="wx-left">身份证号：</span>
														<span class="wx-right">320153256478541239</span>
													</li>
													<li class="wx-li">
														<span class="wx-left">证件照片：</span>
														<span class="wx-right">
															<img src="#checkbox_qx.jpg"/>
															<img src="#checkbox_qx.jpg"/>
														</span>
													</li>
												</ul>
