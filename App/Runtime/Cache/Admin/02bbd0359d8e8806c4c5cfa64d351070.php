							...
							<div class="panel-body body-waiwei">
								...
								<table class="f-tab table-hover table-condensed table-striped table-bordered table dataTable">
									...
									<tbody role="alert" aria-live="polite" aria-relevant="all">
										<!-- 新起一行 -->
										<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$job): $mod = ($i % 2 );++$i;?><tr>
												<td>
													<div class="checkbox checkbox-info checkbox-inline checkbox-single">
														<input id="<?php echo ($job['id']); ?>" type="checkbox">
														<label for="<?php echo ($job['id']); ?>"></label>
													</div>
												</td>
												<td>
													<a href="#" class="text-blue"><?php echo ($job['job_name']); ?></a>
												</td>
												<td><?php echo ($job['company_name']); ?></td>
												<td>已通过</td>
												<td><?php echo (date("Y-m-d H:i:s",$job['refurbish_time'])); ?></td>
												<td>
													2016/09/18 11:21:05
												</td>
												<td>
													<?php echo (date("m-d H:i:s",$job['update_time'])); ?>
												</td>
												<td>
													745
												</td>
												<td>
													<a href="" class="text-primary">(80/120)</a>
												</td>
												<td>
													<a href="<?php echo U('Position/job_update',array('id'=>$job['id']));?>" class="text-primary">修改</a>
												</td>
