                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <a href="#" class="task-thumb">
                                <img src="/newcompany/Public/Admin/img/avatar1.jpg" alt="">
                            </a>
                        ...
                        <div class="panel-body">
                            <div class="media usr-info">
                                <a href="#" class="pull-left">
                                    <img class="thumb" src="/newcompany/Public/Admin/img/avatar1.jpg" alt="">
                                </a>
...
<script src="/newcompany/Public/Admin/js/chart.js" ></script><!-- CHART JS -->
<!--Calendar-->
<script src="/newcompany/Public/Admin/js/calendar/clndr.js"></script><!-- CALENDER JS -->
<script src="/newcompany/Public/Admin/js/calendar/evnt.calendar.init.js"></script><!-- CALENDER EVENT JS -->
