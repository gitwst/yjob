...
$(".leftimg1").toggle(function(){
	$(this).parent().parent().nextAll(".wx-three").show();
    $(this).attr("src","/Public/Admin/img/left_d.gif");

},function(){
	$(this).parent().parent().nextAll(".wx-three").hide();
	$(this).attr("src","/Public/Admin/img/left_e.gif");
	
})


$(".leftimg2").toggle(function(){
	$(this).parent().parent().nextAll(".wx-throu").show();
    $(this).attr("src","/Public/Admin/img/left_d.gif");
},function(){
	$(this).parent().parent().nextAll(".wx-throu").hide();
	$(this).attr("src","/Public/Admin/img/left_e.gif");
})
...
//          $(this).attr("src","/Public/Admin/img/left_e.gif");
//          $(".leftimg1").attr("src","/Public/Admin/img/left_e.gif");
//          $(".leftimg2").attr("src","/Public/Admin/img/left_e.gif");
...
//  });
    ...
    $("#checkbox_qx").click(function(){
        $("li :checkbox").prop("checked",$(this).prop("checked"));
    });
