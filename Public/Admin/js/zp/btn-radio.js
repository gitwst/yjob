...
//            addTrText += '<li><a href="#myModal" data-toggle="modal" ><span style="color: #999999;">个人魅力</span><br><span>80%</span></a></li>'; 
//			  addTrText += '<li></li><li></li>'; 
//            addTrText += '</ul></td></tr>';
...
$(".fa").toggle(function(){
//	console.log($(this));
	$(this).parent().parent().next(".newTr").show();
	$(this).removeClass("fa-plus-circle");
	$(this).addClass("fa-minus-circle");
},function(){
	$(this).parent().parent().next(".newTr").hide();
	$(this).removeClass("fa-minus-circle");
    $(this).addClass("fa-plus-circle");
});
